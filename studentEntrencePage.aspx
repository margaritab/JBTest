<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="studentEntrencePage.aspx.cs" Inherits="studentEntrencePage" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentBody" Runat="Server">
     <div class="entrence">
        ...
        <div id="entrenceLinks">
            <a href="newStudentRegPage.aspx">משתמש חדש</a>
            <br/><br/>
