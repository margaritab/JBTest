<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="systemCreateNewMessagePage.aspx.cs" Inherits="systemCreateNewMessagePage" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentBody" Runat="Server">
    ...
    <div id="messageButtons">
        <asp:Button ID="createMessageButton" OnClick="Create_Message_On_Click" runat="server" Text="הוסף" BackColor="#F00000" ForeColor="White" />
