<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="systemCoursesPage.aspx.cs" Inherits="systemCoursesPage" %>
    ...
    <div class="tableHeadline">
     <h3>רשימת הקורסים</h3>
        ...
        <div id="coursesButtons">
            <asp:Button ID="oldCourses" OnClick="Old_Courses_Button_On_Click" runat="server" Text="צפייה בקורסים קודמים" BackColor="#F00000" ForeColor="White" Height="30"/>
            <asp:Button ID="createNewCourses" OnClick="Create_Courses_Button_On_Click" runat ="server" Text="צור קורס חדש" BackColor="#F00000" ForeColor="White" Height="30"/>
            </div>
   </div>
</asp:Content>
